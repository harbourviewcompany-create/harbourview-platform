...
select 'primary-evidence-ca-cannabis-act-20260922','CA','legal_commercial_access',
'Health Canada states that the Cannabis Act and Cannabis Regulations establish the federal legal framework for production, distribution, sale, import and export; provinces and territories authorize non-medical retail sale through their own systems.',
'Health Canada — Regulations under the Cannabis Act',
...
'2018-10-17',now(),'2027-03-22',true
...
insert into public.regulatory_market_access_evidence
(evidence_key,jurisdiction_iso2,tier,rationale,authority_name,authority_url,source_effective_date,verified_at,expires_at,active)
select 'primary-evidence-ke-narcotics-act-20260922','KE','prohibited',
'Kenya Law publishes the Narcotic Drugs and Psychotropic Substances (Control) Act, which defines cannabis and criminalizes possession and trafficking, while providing narrow statutory exemptions for licensed or medical possession. No general commercial cannabis retail pathway is established by the cited Act.',
'Kenya Law — Narcotic Drugs and Psychotropic Substances (Control) Act',
'https://new.kenyalaw.org/akn/ke/act/1994/4/eng@2022-12-31/source.pdf',
'2022-12-31',now(),'2027-03-22',true
...
select 'primary-evidence-ca-cannabis-act-20260922','CA','primary-evidence-claim:primary-evidence-ca-cannabis-act-20260922',
'Canada has a federal legal framework for commercial cannabis production and sale; provincial and territorial governments authorize non-medical retail sale within their jurisdictions.',
'any','CA','Health Canada — Regulations under the Cannabis Act',
'https://www.canada.ca/en/health-canada/services/drugs-medication/cannabis/laws-regulations/regulations-support-cannabis-act.html','2018-10-17',now(),now(),'2027-03-22','verified'
...
insert into public.regulatory_market_access_claims
(evidence_key,jurisdiction_iso2,claim_key,claim_text,product_class,jurisdiction_scope,authority_name,authority_url,source_effective_date,retrieved_at,verified_at,expires_at,evidence_status)
select 'primary-evidence-ke-narcotics-act-20260922','KE','primary-evidence-claim:primary-evidence-ke-narcotics-act-20260922',
'Kenya’s Narcotic Drugs and Psychotropic Substances (Control) Act defines and controls cannabis and criminalizes possession and trafficking, subject to narrow statutory exemptions; the cited Act does not establish general commercial cannabis retail.',
'any','KE','Kenya Law — Narcotic Drugs and Psychotropic Substances (Control) Act',
'https://new.kenyalaw.org/akn/ke/act/1994/4/eng@2022-12-31/source.pdf','2022-12-31',now(),now(),'2027-03-22','verified'
