...
-- Verbatim statements for version 20260913113111.
...
begin
  ...
  -- 'published_manual' (the non-LLM deterministic fallback added
  -- 2026-08-31) counts as a real delivered edition here, same as
  -- 'published' -- this check previously only recognized 'published' and
  -- so raised false digest_stale / digest_missed_today alerts every day
  -- the fallback ran, even though a digest genuinely went out.
