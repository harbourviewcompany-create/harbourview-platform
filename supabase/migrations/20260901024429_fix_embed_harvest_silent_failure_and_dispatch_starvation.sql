...
-- Applied live via Supabase MCP apply_migration on 2026-09-01 02:44:29 UTC by
...
-- Body md5 matches the live recorded statement: da9c1124705d1d7bb54042fc50a55669
-- Note: this file's own body pins hv_embed_harvest to `public`; that pin was
-- later corrected to `public, extensions` by 20260902021818.
