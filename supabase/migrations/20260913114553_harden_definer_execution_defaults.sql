-- Remove implicit PUBLIC/browser EXECUTE from SECURITY DEFINER routines in
-- controlled application schemas, then restore only the audited authenticated
-- allowlist. Exact repository artifact for live version 20260913114553.
