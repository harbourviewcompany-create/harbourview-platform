-- Forward production security hardening follow-up.
-- Applied to production before repository registration because the existing
-- canonical hardening migration was already recorded there. This file is the
-- exact repository artifact for the live version 20260913114422.
