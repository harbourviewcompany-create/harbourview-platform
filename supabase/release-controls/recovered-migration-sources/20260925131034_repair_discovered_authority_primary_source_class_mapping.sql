...
-- Production migration version: 20260925131034
...
begin
  with candidates as (
    ...
    select c.jurisdiction_iso2,c.jurisdiction_level,null,c.source_class,c.authority_name,c.authority_url,c.source_title,null,lower(c.source_snapshot_sha256),
      c.verified_at,c.verified_at+interval '30 days',
