...
export const COMMAND_CENTRE_COPY = {
  ...
  mobile: {
    ...
    talentDescription: 'Talent opportunities remain separated from counterparty records and are scoped to the active jurisdiction. Role relevance never overrides country context.',
    talentEmptyDetail: 'No reviewed talent record is scoped to the active jurisdiction. Change the operating context to inspect another country; jobs from other countries are not shown here.',
