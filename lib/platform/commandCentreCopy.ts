...
export const COMMAND_CENTRE_COPY = {
  ...
  mobile: {
    ...
    geneticsCommandDescription: 'Public cultivar passports, evidence summaries and controlled genetics opportunities from Harbourview reviewed Genetics contracts.',
    geneticsEmptyDetail: 'Genetics remains available through controlled program and evidence requests.',
    geneticsBoundaryTitle: 'Public Genetics boundary',
    geneticsBoundaryDetail: 'This Command section uses the public cultivar-passport, collaboration and service-provider projections. Private evidence, access grants, internal review notes and audit metadata remain outside this surface. The current passport loader is global rather than jurisdiction- or role-filtered, so the selected Command context is not represented as a Genetics filter.',
