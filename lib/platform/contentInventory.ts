...
export const contentInventory: ContentInventoryItem[] = [
...

  {
    ...
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-country',
    route: '/dashboard/country/[country]',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-country'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-market-panel',
    route: '/dashboard/country/[country]/market',
    title: 'Market panel',
    pillar: 'intelligence',
    sensitivity: 'intelligence',
    visibility: 'mixed',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-market-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-education-panel',
    route: '/dashboard/country/[country]/education',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-education-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-compliance-panel',
    route: '/dashboard/country/[country]/compliance',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-compliance-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-signals-panel',
    route: '/dashboard/country/[country]/signals',
    title: 'Signals panel',
    pillar: 'intelligence',
    sensitivity: 'intelligence',
    visibility: 'mixed',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-signals-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-opportunities-panel',
    route: '/dashboard/country/[country]/opportunities',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-opportunities-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-intelligence-panel',
    route: '/dashboard/country/[country]/intelligence',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-intelligence-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    id: 'dashboard-connections-panel',
    route: '/dashboard/country/[country]/connections',
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-connections-panel'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['globe-routing-overlay'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
  {
    ...
    sourceBasis: 'static-orientation',
    reviewerRequired: true,
    relatedCapabilityIds: ['country-directory-fallback'],
    falseGoRisk: 'Dashboard routes can be mistaken for complete live intelligence unless public-safe status labels are rendered.',
  },
]
