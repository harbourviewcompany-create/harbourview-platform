...
export const contentInventory: ContentInventoryItem[] = [
  ...
  },
  {
    ...
    falseGoRisk: 'Dashboard entry may imply fully live country intelligence coverage.',
  },
  {
    ...
    sourceBasis: 'admin-reviewed',
    reviewerRequired: true,
    relatedCapabilityIds: ['dashboard-country-routes'],
    falseGoRisk: 'Country route mapping can expose incomplete or unresolved geography without safe fallback states.',
  },
]
