...
export const consumables: Listing[] = [
  ...
  },
  {
    ...
    tags: ['Lab & QA', 'Testing Supplies', 'Recurring Program', 'Compliance', '1,000 units', 'Inquiry Required'],
    ...common,
  },
  {
    id: 'cons-003',
    ...
    tags: ['Cultivation', 'Nutrients', 'Grow Media', 'Indoor & Greenhouse', 'Recurring Supply', 'Licensed Cultivators', '25 units', 'Inquiry Required'],
    ...common,
  },
  {
    id: 'cons-004',
    ...
    tags: ['Processing', 'Extraction', 'Lab Disposables', 'CO₂ & Ethanol Compatible', 'Recurring Supply', '500 units', 'Inquiry Required'],
    ...common,
  },
  {
    id: 'cons-005',
    ...
    tags: ['Sanitation', 'PPE', 'Facility Compliance', 'Recurring Supply', 'Licensed Operators', 'Inquiry Required'],
    ...common,
  },
  {
    id: 'cons-006',
  ...
  },
  {
    ...
    tags: ['Maintenance', 'Facility Upkeep', 'Multi-Site', 'Safety Supplies', 'Licensed Operators', 'Inquiry Required'],
    ...common,
  },
