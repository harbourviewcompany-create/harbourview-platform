...
export const consumables: Listing[] = [
  ...
  },
  {
    ...
    description:
      'Recurring supply of cultivation operating inputs for licensed indoor and greenhouse operators. Covers base nutrients and supplements, coco and peat media, pH and EC management supplies, monitoring consumables and recurring facility materials. Seasonal and annualised supply programs available for multi-room cultivation sites and commercial-scale facilities. Volume, SKU mix and delivery region reviewed by inquiry. Inquiry required through Harbourview.',
    tags: ['Cultivation', 'Nutrients', 'Grow Media', 'Indoor & Greenhouse', 'Recurring Supply', 'Commercial Scale', 'Inquiry Required'],
    ...common,
  },
  {
    id: 'cons-004',
