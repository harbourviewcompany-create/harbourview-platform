...
export const cannabisInventoryListings: CannabisInventoryListing[] = [
  ...
  },
  {
    id: 'ci-005',
    category: 'cannabis-inventory',
    title: 'GMP Bulk Cannabis Extract — Canadian LP, 10–50kg Per Lot, EU & UK Export',
    description:
      'GMP-certified cannabis extract produced by a licensed Canadian LP under Health Canada oversight, available for export to licensed EU and UK operators. 10kg minimum per lot, up to 50kg available per lot. Full certificate of analysis, GMP documentation, and export permit support provided for each shipment. Suitable for licensed importers and cannabis operators holding applicable national import licences. Import compliance is the responsibility of the receiving party. Introductions managed through Harbourview — import licence verification required before introduction.',
    price: 'POA',
  ...
  },
  {
    id: 'ci-006',
    category: 'cannabis-inventory',
    title: 'EU-GMP Dried Flower — German Licensed Producer, 5kg+ Per Cultivar, Licensed Importers',
    description:
      'EU-GMP-certified dried cannabis flower from a licensed producer in Germany, available for import by operators holding valid national import licences. Multiple cultivars available; 5kg minimum order per cultivar. New lot supply available now. COA and GMP certificates provided for every lot. Suitable for licensed cannabis operators and importers in EU and UK markets with active import authorisation. Import compliance is the responsibility of the receiving party. Introductions managed through Harbourview — import licence verification required before introduction.',
    price: 'POA',
