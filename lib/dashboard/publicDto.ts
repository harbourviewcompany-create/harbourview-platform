...
import type { CountryDashboardRecord, CountryDashboardPublicRecordDto } from './commercialDashboard'
...
export function serializeCommercialCountryDashboardPublicDto(record: CountryDashboardRecord): CountryDashboardPublicRecordDto {
  return {
    slug: record.slug,
    iso2: record.iso2,
    iso3: record.iso3,
