...
export function resolveCommercialDashboardSelection(
  ...
  return {
    selectedRole: readQueryValue(params.role) ? normalizeCountryDashboardRole(readQueryValue(params.role)) : defaultRole,
    selectedLayer: normalizeCountryHeatmapLayer(readQueryValue(params.layer)),
  }
}
