...
export const demoAccessGrants: GeneticsAccessGrantRow[] = [
  {
    id: '24500000-0000-4000-8000-000000000001',
    access_request_id: demoAccessRequests[0].id,
    cultivar_id: demoCultivarPassports[0].id,
    grantee_profile_id: demoGeneticsProfiles[2].id,
    grantor_profile_id: demoGeneticsProfiles[0].id,
    grantor_user_id: null,
    grant_scope: 'Demo limited provenance-summary review only; no raw genotype, COA, pathogen, protocol, IP, MTA, pricing, or licensing-term access.',
    allowed_evidence_item_ids: [demoEvidenceItems[0].id],
    allowed_evidence_types: ['provenance_note'],
    status: 'active',
    starts_at: now,
...
export const demoClaims: GeneticsClaimRow[] = [
  {
    id: '24600000-0000-4000-8000-000000000001',
    cultivar_id: demoCultivarPassports[0].id,
    claim_kind: 'provenance',
    claim_label: 'Demo provenance placeholder exists',
    claim_text: 'A demo provenance placeholder exists for workflow demonstration only.',
    claim_status: 'evidence_provided',
    review_status: 'evidence_attached',
    public_display_allowed: false,
    public_display_text: null,
    evidence_item_id: demoEvidenceItems[0].id,
    evidence_scope: 'Demo workflow only',
    evidence_source_label: 'Harbourview demo seed file',
    evidence_source_date: '2026-06-07',
    reviewer_user_id: null,
    private_notes: 'Demo private claim note hidden from public DTO.',
    created_at: now,
    updated_at: now,
  },
  {
    id: '24600000-0000-4000-8000-000000000002',
    cultivar_id: demoCultivarPassports[1].id,
    claim_kind: 'export_readiness',
    claim_label: 'Export-ready restricted claim blocked',
    claim_text: 'Demo restricted export-ready claim requiring reviewed evidence before display.',
    claim_status: 'not_assessed',
    review_status: 'needs_evidence',
    public_display_allowed: false,
    public_display_text: null,
    ...
    evidence_source_date: null,
    reviewer_user_id: null,
    private_notes: 'Do not publish export-ready language without reviewed evidence.',
    created_at: now,
    updated_at: now,
  },
]
