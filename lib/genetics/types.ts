...
export type GeneticsAccessGrantRow = { id: string; cultivar_id: string; grantor_profile_id: string; grantee_profile_id: string; grant_type: OpportunityType; allowed_evidence_item_ids: string[]; allowed_evidence_types: EvidenceType[]; status: 'active' | 'revoked' | 'expired'; starts_at: string; expires_at: string | null; revoked_at: string | null; revocation_reason: string | null; created_at: string; updated_at: string }
