...
export type GeneticsAccessGrantRow = { id: string; access_request_id: string | null; cultivar_id: string; grantee_profile_id: string; grantor_profile_id: string | null; grantor_user_id: string | null; grant_scope: string; allowed_evidence_item_ids: string[]; allowed_evidence_types: EvidenceType[]; status: AccessGrantStatus; starts_at: string; expires_at: string | null; revoked_at: string | null; revoked_by: string | null; revocation_reason: string | null; created_at: string; updated_at: string }
export type GeneticsClaimRow = { id: string; cultivar_id: string; claim_kind: GeneticsClaimKind; claim_label: string; claim_text: string; claim_status: ClaimStatus; review_status: ClaimReviewStatus; public_display_allowed: boolean; public_display_text: string | null; evidence_item_id: string | null; evidence_scope: string | null; evidence_source_label: string | null; evidence_source_date: string | null; reviewer_user_id: string | null; private_notes: string | null; created_at: string; updated_at: string }
