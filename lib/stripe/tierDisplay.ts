...
// server-only) so client components can render tier names, pricing, and
// feature lists without pulling the Stripe SDK into the client bundle.
// lib/stripe/server.ts re-exports this for backward compatibility.
