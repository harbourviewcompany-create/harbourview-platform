...
function makeSourcingMandatePayload(overrides = {}) {
  return {
    id: crypto.randomUUID(),
    listing_id: null,
    buyer_request_id: null,
    ...
    message: [
      `${SMOKE_MARKER}: confidential intake capture smoke test.`,
      '',
      'Harbourview confidential intake',
      '',
      'Nature of Discussion: General Enquiry',
      '',
      'Details:',
      'Smoke test confidential intake generated by automated marketplace capture verification.',
    ].join('\n'),
    status: 'received',
    ...overrides,
  };
