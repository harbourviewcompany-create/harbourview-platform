...
const routes = [
  ...
  },
  {
    ...
    mustInclude: ['Global policy and regulatory change monitoring', 'Request Signals Access'],
  ...
  },
  {
    ...
    mustInclude: ['Commercial briefs', 'Request a Briefing'],
    mustNotInclude: ['/commercial-intelligence'],
  },
  {
    path: '/contact',
  ...
  },
  {
    path: '/intake',
    okStatuses: [200],
    titleIncludes: 'Confidential Intake',
    mustInclude: ['Confidential Intake', 'Request a Confidential Discussion'],
