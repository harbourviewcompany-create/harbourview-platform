...
function transformFeature(feature) {
  ...
  if (!iso2 || !iso3 || SKIP_ISO2.has(iso2) || SKIP_ISO3.has(iso3)) return null
...
async function main() {
  ...
  assertUniqueIso2RoutingKeys(countries)
