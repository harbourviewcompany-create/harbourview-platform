 ...
 *
 * HF token note: this class no longer reads HF_TOKEN or HF_INFERENCE_ENDPOINT.
 * If HF extraction is re-enabled here in the future, use HF_TOKEN_SERVER and
 * HF_ENDPOINT_EXTRACT_QWEN3_4B exclusively — see lib/hf/env.ts.
 */
