...
|---|---|---|---|---|---|
| 2026-08-15 | Reconciled stale control-doc authority notices -- `SOURCE_OF_TRUTH.md` (frozen 2026-05-28), `CURRENT_STATE.md` (frozen 2026-06-29), `PROJECT_STATE.md` (frozen mid-May, references superseded PR #314) vs. root `HANDOFF.md`'s 2026-08-11 state | Docs-only, no command | Added the same superseded/redirect banner pattern already used on `docs/control/AGENT_HANDOFF.md` (PR #1112, 2026-07-21) directly to the three files it named but never itself updated -- no content deleted, all three kept as historical record pointing to root `HANDOFF.md` as current authority | PR TBD | Current |
