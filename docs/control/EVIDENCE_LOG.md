...
|---|---|---|---|---|---|
| 2026-08-11 | PR #1336 post-merge small-country retention remediation | `node scripts/generate-natural-earth-countries.mjs` x2; targeted topology/Russia/rendering Vitest; `npm run lint`; `npm run typecheck`; `npm run test`; `npm run test:security`; `npm run build` | PASS — transform `1.5.0-natural-earth-50m-antimeridian-source-retention-alpha2`; VI retained; IOA excluded; Russia geometry unchanged; normalized SHA-256 `7efef36d3baa4596ecc70963cb595b2a4c16ab1521fa197ccb0ab8ff241ca655` | PR #1336; final verification workflow on remediation branch | **Current — GO on verified head** |
