...
Status: Canonical registry with confirmed Harbourview Vercel production mapping  
Scope: GitHub, Vercel and Supabase assets visible in the connected audit plus operator-pasted Vercel production evidence  
...
| Canonical production domain | `https://harbourview.vercel.app` | Confirmed canonical production domain | Confirmed from operator-pasted Vercel production deployment evidence. |
