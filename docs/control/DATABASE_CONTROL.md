...
- Required tests: `npm run test:signal-routing` (37 assertions) covers the read-side matcher. No test covers view shape — that is the gap the CI check above would close.
