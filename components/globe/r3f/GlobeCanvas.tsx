...
export function GlobeCanvas({
  ...
  const globeInteractionRegionStyle = {
    width: 'min(88vw, 88vh)',
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      <div
        className="pointer-events-auto absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-full"
        style={globeInteractionRegionStyle}
        aria-label="Interactive globe region"
      >
        <Canvas
          dpr={[1, 1.75]}
          camera={{
