...
export function useMobileCommandModel(props: MobileCommandCentreProps) {
  ...
  const nextActions = useMemo<NextAction[]>(() => {
    ...
    return actions
  }, [commandHref, countryLabel, currentRole, educationTiles.length, marketRows, pipeline.inquiry, pipeline.proof_review, props.countryIntel, props.hasOrg, props.wantedCount, roleShort, signals])
