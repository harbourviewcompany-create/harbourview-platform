...
.org-sub { font-size: .78rem; color: #8a8a9a; margin-top: 6px; }
          ...
          <div className="org-sub">Your organization is already set up. License and facility management is coming to this section next.</div>
        </div>
      </div>
    )
  }
...
.org-title { font-size: 1.3rem; font-weight: 700; color: #f5f0e8; }
.org-sub { font-size: .78rem; color: #8a8a9a; margin-top: 6px; }
.org-done-icon { color: #10b981; font-size: 2.4rem; margin-bottom: 10px; }
          `}</style>
          <div className="org-done-icon">✓</div>
          <div className="org-title">Organization created</div>
          <div className="org-sub">Your Passport verification has started — unverified by default until you submit for review.</div>
        </div>
      </div>
    )
  }
