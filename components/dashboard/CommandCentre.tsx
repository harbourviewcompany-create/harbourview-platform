...
type Props = {
  ...
  // target for the old /dashboard/signals/search route, which other parts
  // of the app (mobile cross-command search) link to expecting a full-corpus
  // search view, not the default filtered feed.
