...
import type { GeneticsCommandRecords } from './mobile-command/sections/DomainSections'
...
// Keep the mobile shell small: section implementations are grouped by domain and
