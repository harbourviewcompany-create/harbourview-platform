...
// ISO-3166-1 alpha-2/alpha-3 pairs. Names are resolved by the platform's
// standard Intl implementation so the registry does not carry a second,
// drift-prone country-name dataset.
