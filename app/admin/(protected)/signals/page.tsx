...
export default async function AdminSignalsPage() {
  ...
  const [signalsResult, sourcesResult] = await Promise.all([listRegulatorySignals(), listRegulatorySources()])
  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-[#F5F1E8]/65">Official sources are checked, stored as private snapshots, converted into draft signals, and held for review before public display.</p>
      </div>
