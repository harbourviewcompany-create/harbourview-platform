...
export default async function MarketDashboardPage({
  ...
  if (!country) notFound()
  const { selectedRole, selectedLayer } = resolveCommercialDashboardSelection(resolvedSearch, getDefaultRoleForDashboardSection('market'))
  return <CountryDashboardShell country={country} section="market" selectedRole={selectedRole} selectedLayer={selectedLayer} />
}
