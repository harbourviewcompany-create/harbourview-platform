...
export async function generateMetadata({ params }: { params: Promise<{ country: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${displayName} Connections | Harbourview`,
    description: `Harbourview ${displayName} connections dashboard. Country-level market intelligence, pathway context and commercial routing for regulated cannabis.`,
  }
}
