...
export default async function EducationDashboardPage({
  ...
  if (!country) notFound()
  const { selectedRole, selectedLayer } = resolveCommercialDashboardSelection(resolvedSearch, getDefaultRoleForDashboardSection('education'))
  return <CountryDashboardShell country={country} section="education" selectedRole={selectedRole} selectedLayer={selectedLayer} />
}
