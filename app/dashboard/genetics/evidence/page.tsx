...
export default function GeneticsEvidenceDashboardPage() {
  const evidence = getInternalCultivarPassports().flatMap((passport) => passport.privateEvidenceMetadata.map((item) => ({ ...item, cultivar: passport.displayName })))
