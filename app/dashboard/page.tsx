...
import { getPipelineCounts, getWantedListings, getLiveEduTiles, getCountryIntelProfile, getOrgPathwayProgress, getWatchlistData, getEvidenceData, getRecentEduModules } from '@/lib/dashboard/dashboardLiveData'
...
export default async function DashboardPage({
  ...
  const [signals, wantedCount, marketplaceRows, pipeline, wantedListings, countryIntel, liveEduTiles, pathwayData, watchlistData, evidenceData, recentEduModules] = await Promise.all([
