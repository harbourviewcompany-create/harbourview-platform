...
// Supplier records are live and approval state can change at any time. Keep this page out of
// the build-time static generation path so production builds never block on Supabase data.
