  ...
  return (
    <main>
      ...
      <FooterCta
        ...
        title="Have a supplier profile or introduction request to submit?"
        actions={[
          { label: 'Submit your company', href: '/supplier-directory/apply' },
          { label: 'Request an introduction', href: '/contact', variant: 'secondary' },
        ]}
      >
        Submit a supplier profile for Harbourview review. Public visibility and routing are not automatic.
      </FooterCta>
    </main>
  )
}
