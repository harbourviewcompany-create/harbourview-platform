...
const FLAGS: Record<string, string> = {
  DE: 'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂª', GB: 'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§', AU: 'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂº', CA: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¦', NL: 'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ±',
  PT: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¹', TH: 'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ­', IL: 'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ±', CO: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ´', ZA: 'ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ¦',
  MT: 'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¹', LU: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂº', CZ: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¿', NZ: 'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ¿', MX: 'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ½',
  BR: 'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ·', CH: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ­', FR: 'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ·', ES: 'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¸', PL: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ±',
  AE: 'Ã°ÂÂÂ¦Ã°ÂÂÂª', AG: 'Ã°ÂÂÂ¦Ã°ÂÂÂ¬', AR: 'Ã°ÂÂÂ¦Ã°ÂÂÂ·', AT: 'Ã°ÂÂÂ¦Ã°ÂÂÂ¹', BA: 'Ã°ÂÂÂ§Ã°ÂÂÂ¦', BB: 'Ã°ÂÂÂ§Ã°ÂÂÂ§', BE: 'Ã°ÂÂÂ§Ã°ÂÂÂª',
  CL: 'Ã°ÂÂÂ¨Ã°ÂÂÂ±', CR: 'Ã°ÂÂÂ¨Ã°ÂÂÂ·', DK: 'Ã°ÂÂÂ©Ã°ÂÂÂ°', DM: 'Ã°ÂÂÂ©Ã°ÂÂÂ²', DO: 'Ã°ÂÂÂ©Ã°ÂÂÂ´', EC: 'Ã°ÂÂÂªÃ°ÂÂÂ¨', EE: 'Ã°ÂÂÂªÃ°ÂÂÂª',
  FI: 'Ã°ÂÂÂ«Ã°ÂÂÂ®', GD: 'Ã°ÂÂÂ¬Ã°ÂÂÂ©', GH: 'Ã°ÂÂÂ¬Ã°ÂÂÂ­', GR: 'Ã°ÂÂÂ¬Ã°ÂÂÂ·', GY: 'Ã°ÂÂÂ¬Ã°ÂÂÂ¾', HR: 'Ã°ÂÂÂ­Ã°ÂÂÂ·', HU: 'Ã°ÂÂÂ­Ã°ÂÂÂº',
  IE: 'Ã°ÂÂÂ®Ã°ÂÂÂª', IS: 'Ã°ÂÂÂ®Ã°ÂÂÂ¸', JM: 'Ã°ÂÂÂ¯Ã°ÂÂÂ²', JP: 'Ã°ÂÂÂ¯Ã°ÂÂÂµ', KN: 'Ã°ÂÂÂ°Ã°ÂÂÂ³', KR: 'Ã°ÂÂÂ°Ã°ÂÂÂ·', LB: 'Ã°ÂÂÂ±Ã°ÂÂÂ§',
  LC: 'Ã°ÂÂÂ±Ã°ÂÂÂ¨', LI: 'Ã°ÂÂÂ±Ã°ÂÂÂ®', LT: 'Ã°ÂÂÂ±Ã°ÂÂÂ¹', LV: 'Ã°ÂÂÂ±Ã°ÂÂÂ»', MK: 'Ã°ÂÂÂ²Ã°ÂÂÂ°', MU: 'Ã°ÂÂÂ²Ã°ÂÂÂº', NO: 'Ã°ÂÂÂ³Ã°ÂÂÂ´',
  PA: 'Ã°ÂÂÂµÃ°ÂÂÂ¦', PE: 'Ã°ÂÂÂµÃ°ÂÂÂª', PH: 'Ã°ÂÂÂµÃ°ÂÂÂ­', PR: 'Ã°ÂÂÂµÃ°ÂÂÂ·', RO: 'Ã°ÂÂÂ·Ã°ÂÂÂ´', RS: 'Ã°ÂÂÂ·Ã°ÂÂÂ¸', SC: 'Ã°ÂÂÂ¸Ã°ÂÂÂ¨',
  SE: 'Ã°ÂÂÂ¸Ã°ÂÂÂª', SG: 'Ã°ÂÂÂ¸Ã°ÂÂÂ¬', SI: 'Ã°ÂÂÂ¸Ã°ÂÂÂ®', SK: 'Ã°ÂÂÂ¸Ã°ÂÂÂ°', TR: 'Ã°ÂÂÂ¹Ã°ÂÂÂ·', TT: 'Ã°ÂÂÂ¹Ã°ÂÂÂ¹', UA: 'Ã°ÂÂÂºÃ°ÂÂÂ¦',
  US: 'Ã°ÂÂÂºÃ°ÂÂÂ¸', UY: 'Ã°ÂÂÂºÃ°ÂÂÂ¾', VC: 'Ã°ÂÂÂ»Ã°ÂÂÂ¨',
}

const LEGAL_LABEL: Record<string, string> = {
  medical_only: 'Medical only', adult_use: 'Adult-use', decrim: 'Decriminalised',
  illegal: 'Prohibited', mixed: 'Mixed', transitional: 'Transitional', unknown: 'ÃÂ¢ÃÂÃÂ',
}
    ...
    <main style={{ minHeight: '100vh', background: '#050c18', color: '#f5f0e8', fontFamily: 'inherit' }}>
      ...
      <div className="rp-wrap">
        ...
        <nav className="rp-nav">
          ...
          <span className="rp-sep">ÃÂ¢ÃÂÃÂº</span>
                ...
                <div className="rp-model-markets">
                  {model.markets.map(iso2 => {
                    ...
                    return (
                      ...
                      >
                        {FLAGS[iso2] ?? 'ÃÂ°ÃÂÃÂÃÂ'} {iso2}
                      </Link>
                    )
                  })}
                </div>
                    ...
                    {(byStatus[status] ?? []).slice(0, 20).map(b => {
                      ...
                      return (
                        <Link
                          ...
                          title={b.headline}
                        >
                          {FLAGS[b.country_iso2] ?? 'ÃÂ°ÃÂÃÂÃÂ'} {b.country_name ?? b.country_iso2}
                          <span className="rp-fw-mat" style={{ color }}>ÃÂÃÂ· {b.market_maturity}</span>
                        </Link>
                      )
                    })}
        ...
        {playbooks.length > 0 && (
          <section className="rp-section">
            ...
            <p className="rp-section-sub">Step-by-step licensing sequences for {playbooks.length} priority markets ÃÂ¢ÃÂÃÂ named regulators, pathway steps, and typical timelines.</p>
            <div className="rp-playbooks">
              {playbooks.map(pb => (
                <Link key={pb.country_iso2} href={`/intelligence/playbooks/${pb.country_iso2.toLowerCase()}`} className="rp-pb">
                  <span className="rp-pb-flag">{FLAGS[pb.country_iso2] ?? 'ÃÂ°ÃÂÃÂÃÂ'}</span>
                  <div className="rp-pb-meta">
                    <span className="rp-pb-name">{pb.country_name}</span>
                    <span className="rp-pb-detail">{pb.steps.length} steps ÃÂÃÂ· {pb.typical_timeline_months}mo ÃÂÃÂ· {pb.key_regulators.length} regulator{pb.key_regulators.length !== 1 ? 's' : ''}</span>
                  </div>
                  <span className="rp-pb-arr">ÃÂ¢ÃÂÃÂ</span>
                </Link>
              ))}
            </div>
          </section>
        ...
        <section className="rp-cta">
          ...
          <p className="rp-cta-body">
            ...
            regulatory engagements are handled through Harbourview&apos;s confidential intake ÃÂ¢ÃÂÃÂ not this
            public surface. Harbourview does not provide legal advice.
          </p>
          <div className="rp-cta-actions">
            <Link href="/intake" className="rp-gold">Start Confidential Intake ÃÂ¢ÃÂÃÂ</Link>
        ...
        <footer className="rp-footnote">
          ...
          <div className="rp-f-links">
            <Link href="/intelligence/playbooks">Market Playbooks ÃÂ¢ÃÂÃÂ</Link>
            <Link href="/intelligence/licensing-pathways">Licensing Pathways ÃÂ¢ÃÂÃÂ</Link>
            <Link href="/markets">Market Briefings ÃÂ¢ÃÂÃÂ</Link>
          </div>
        </footer>
      </div>
    </main>
