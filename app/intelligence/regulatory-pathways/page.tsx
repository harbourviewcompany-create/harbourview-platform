...
const FLAGS: Record<string, string> = {
  DE: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ©ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂª', GB: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¬ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ§', AU: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂº', CA: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦', NL: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ±',
  PT: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¹', TH: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ­', IL: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ®ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ±', CO: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ´', ZA: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¿ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦',
  MT: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¹', LU: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂº', CZ: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¿', NZ: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¿', MX: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ½',
  BR: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ·', CH: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ­', FR: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ«ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ·', ES: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¸', PL: 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ±',
  AE: 'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂª', AG: 'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¬', AR: 'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ·', AT: 'ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¹', BA: 'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¦', BB: 'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ§', BE: 'ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂª',
  CL: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ±', CR: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ·', DK: 'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ°', DM: 'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ²', DO: 'ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ´', EC: 'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¨', EE: 'ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂª',
  FI: 'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ®', GD: 'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ©', GH: 'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ­', GR: 'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ·', GY: 'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¾', HR: 'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ·', HU: 'ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂº',
  IE: 'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂª', IS: 'ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¸', JM: 'ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂ²', JP: 'ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂµ', KN: 'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ³', KR: 'ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ·', LB: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ§',
  LC: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¨', LI: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ®', LT: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¹', LV: 'ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ»', MK: 'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ°', MU: 'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂº', NO: 'ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ´',
  PA: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¦', PE: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂª', PH: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ­', PR: 'ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ·', RO: 'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ´', RS: 'ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ¸', SC: 'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¨',
  SE: 'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂª', SG: 'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¬', SI: 'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ®', SK: 'ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ°', TR: 'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ·', TT: 'ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¹', UA: 'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¦',
  US: 'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¸', UY: 'ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¾', VC: 'ÃÂ°ÃÂÃÂÃÂ»ÃÂ°ÃÂÃÂÃÂ¨',
  BG: '🇧🇬', CY: '🇨🇾',
}

const LEGAL_LABEL: Record<string, string> = {
  medical_only: 'Medical only', adult_use: 'Adult-use', decrim: 'Decriminalised',
  illegal: 'Prohibited', mixed: 'Mixed', transitional: 'Transitional', unknown: 'ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ',
}
    ...
    <main style={{ minHeight: '100vh', background: '#050c18', color: '#f5f0e8', fontFamily: 'inherit' }}>
      ...
      <div className="rp-wrap">
        ...
        <nav className="rp-nav">
          ...
          <span className="rp-sep">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂº</span>
                ...
                <div className="rp-model-markets">
                  {model.markets.map(iso2 => {
                    ...
                    return (
                      ...
                      >
                        {FLAGS[iso2] ?? 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ'} {iso2}
                      </Link>
                    )
                  })}
                </div>
                    ...
                    {(byStatus[status] ?? []).slice(0, 20).map(b => {
                      ...
                      return (
                        <Link
                          ...
                          title={b.headline}
                        >
                          {FLAGS[b.country_iso2] ?? 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ'} {b.country_name ?? b.country_iso2}
                          <span className="rp-fw-mat" style={{ color }}>ÃÂÃÂÃÂÃÂ· {b.market_maturity}</span>
                        </Link>
                      )
                    })}
        ...
        {playbooks.length > 0 && (
          <section className="rp-section">
            ...
            <p className="rp-section-sub">Step-by-step licensing sequences for {playbooks.length} priority markets ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ named regulators, pathway steps, and typical timelines.</p>
            <div className="rp-playbooks">
              {playbooks.map(pb => (
                <Link key={pb.country_iso2} href={`/intelligence/playbooks/${pb.country_iso2.toLowerCase()}`} className="rp-pb">
                  <span className="rp-pb-flag">{FLAGS[pb.country_iso2] ?? 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ'}</span>
                  <div className="rp-pb-meta">
                    <span className="rp-pb-name">{pb.country_name}</span>
                    <span className="rp-pb-detail">{pb.steps.length} steps ÃÂÃÂÃÂÃÂ· {pb.typical_timeline_months}mo ÃÂÃÂÃÂÃÂ· {pb.key_regulators.length} regulator{pb.key_regulators.length !== 1 ? 's' : ''}</span>
                  </div>
                  <span className="rp-pb-arr">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</span>
                </Link>
              ))}
            </div>
          </section>
        ...
        <section className="rp-cta">
          ...
          <p className="rp-cta-body">
            ...
            regulatory engagements are handled through Harbourview&apos;s confidential intake ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not this
            public surface. Harbourview does not provide legal advice.
          </p>
          <div className="rp-cta-actions">
            <Link href="/intake" className="rp-gold">Start Confidential Intake ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</Link>
        ...
        <footer className="rp-footnote">
          ...
          <div className="rp-f-links">
            <Link href="/intelligence/playbooks">Market Playbooks ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</Link>
            <Link href="/intelligence/licensing-pathways">Licensing Pathways ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</Link>
            <Link href="/markets">Market Briefings ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</Link>
          </div>
        </footer>
      </div>
    </main>
