...
export default function SourceEnginePage() {
  return (
    <PublicSurfacePage
      ...
      boundary="This route explains request handling only. It does not publish raw source URLs, sourceEvidence, provenanceSummary, internal review notes, analyst conclusions, non-public contact paths or live counterparty intelligence."
