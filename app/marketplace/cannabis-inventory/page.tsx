...
export const metadata: Metadata = {
  title: 'Cannabis Inventory | Harbourview',
  description:
    'Bulk cannabis, biomass, extract and regulated product supply for licensed operators. All inventory subject to Harbourview qualification.',
}
...
function ListingCard({ listing }: { listing: PublicListing }) {
  ...
  return (
    <div className="group flex flex-col rounded-sm border border-gold/10 bg-[linear-gradient(180deg,rgba(10,20,35,0.94)_0%,rgba(5,12,22,0.98)_100%)] p-6 shadow-[0_18px_44px_rgba(0,0,0,0.22)] transition-all duration-200 hover:border-gold/30">
      ...
      <Link
        href={getPublicListingHref(listing, 'cannabis_inventory')}
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="mb-2 text-lg font-semibold text-[#f5f1e8]">No inventory listed</p>
      <p className="mb-6 text-sm leading-7 text-white/54">
        Licensed supply is available through Harbourview review on request.
      </p>
      ...
      <section className="relative overflow-hidden border-b border-gold/10 bg-[#061120] py-14 text-white sm:py-16 lg:py-20">
        ...
        <div className="page-container relative z-10">
          ...
          <h1 className="max-w-4xl font-serif text-[2.2rem] leading-[1.06] tracking-normal text-[#f5f1e8] sm:text-5xl lg:text-6xl">
            Licensed cannabis supply for qualified operators.
          </h1>
          <div className="mt-6 max-w-3xl text-base leading-8 text-white/62 sm:text-lg">
            <p>
              Bulk cannabis, biomass, extract and regulated product supply. Compliance documentation,
              counterparty credentials and availability are confirmed through Harbourview review before
              any introduction.
            </p>
          </div>
        ...
        <div className="page-container">
          <div className="rounded-sm border border-gold/20 bg-[linear-gradient(180deg,rgba(10,20,35,0.94)_0%,rgba(5,12,22,0.98)_100%)] p-6">
            ...
            <p className="text-sm leading-7 text-white/62">
              Cannabis supply introductions require regulatory compliance verification, INCB quota
              confirmation where applicable, and Harbourview counterparty qualification before any
              introduction. Public summaries do not expose seller identity, pricing, batch documentation
              or import/export eligibility.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="page-container">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="font-serif text-3xl leading-tight tracking-[-0.035em] text-[#f5f1e8] sm:text-4xl">
                Submit licensed inventory for Harbourview review.
              </h2>
              <p className="mt-4 text-sm leading-7 text-white/58">
                EU-GMP certified flower, extract, API and biomass. Publication and introduction routing
                are not automatic and require qualification.
              </p>
            </div>
