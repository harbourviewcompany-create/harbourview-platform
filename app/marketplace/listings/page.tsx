        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight md:text-6xl">
              Reviewed commercial opportunities across global cannabis supply and demand.
            </h1>
          </div>
          <div className="rounded-2xl border border-[#C6A55A]/25 bg-[#0B1A2F]/70 p-5 text-sm leading-6 text-[#F5F1E8]/72">
            <p>
              These are Harbourview-reviewed Network opportunities. Availability, counterparty engagement and commercial handoff are handled through controlled qualification before any introduction.
            </p>
          </div>
        </div>
