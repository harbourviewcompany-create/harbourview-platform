...
export default async function RegulatorySignalDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <Link href="/signals" className="mb-8 inline-block text-xs text-neutral-500 underline">Back to Signals</Link>
      ...
      {signal.canonical_source_url && (
        <a href={signal.canonical_source_url} target="_blank" className="mt-6 inline-block text-xs text-neutral-500 underline">
