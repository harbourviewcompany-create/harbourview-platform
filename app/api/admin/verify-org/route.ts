...
export async function POST(req: NextRequest) {
  ...
  await supabase.from("audit_events").insert({
    entity_type: "workspace", entity_id: org_id,
    action: "org.verification_status.changed", actor: user.id, actor_user_id: user.id,
    metadata: { verification_status, queue_id: queue_id ?? null },
  })
