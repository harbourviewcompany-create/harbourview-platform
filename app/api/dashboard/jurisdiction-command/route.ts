  ...
  try {
    ...
    const dto: JurisdictionCommandDTO = {
      ...
      dataDepth: dataDepth ? {
        ...
        countryIntelRows: dataDepth.active_country_intel_rows,
        evidenceRows: dataDepth.evidence_rows,
        currentVerifiedEvidenceRows: dataDepth.current_verified_evidence_rows,
        snapshottedEvidenceRows: dataDepth.snapshotted_evidence_rows,
        claimRows: dataDepth.claim_rows,
        verifiedClaimRows: dataDepth.verified_claim_rows,
        claimProductClasses: dataDepth.claim_product_classes,
        pathwayRows: dataDepth.pathway_rows,
        verifiedPathwayRows: dataDepth.verified_pathway_rows,
        pathwayTypes: dataDepth.pathway_types,
        formatRuleRows: dataDepth.format_rule_rows,
        verifiedFormatRuleRows: dataDepth.verified_format_rule_rows,
        distinctFormats: dataDepth.distinct_formats,
        metricRows: dataDepth.metric_rows,
        metricTypes: dataDepth.metric_types,
        tradeFlowRows: dataDepth.trade_flow_rows,
        tradeProductCategories: dataDepth.trade_product_categories,
        signalRows: dataDepth.signal_rows,
        recentSignalRows: dataDepth.recent_signal_rows,
        activeSourceRows: dataDepth.active_source_rows,
        officialSourceRows: dataDepth.official_source_rows,
        snapshotRows: dataDepth.snapshot_rows,
        successfulSnapshotRows: dataDepth.successful_snapshot_rows,
        calendarRows: dataDepth.calendar_rows,
        openCalendarRows: dataDepth.open_calendar_rows,
        latestSourceCheck: dataDepth.latest_source_check,
        latestSnapshotAt: dataDepth.latest_snapshot_at,
        latestSignalAt: dataDepth.latest_signal_at,
        latestEvidenceVerifiedAt: dataDepth.latest_evidence_verified_at,
        latestPathwayVerifiedAt: dataDepth.latest_pathway_verified_at,
      } : null,
